        ...
        */
        ...
        showModal: function(id, trans) {
            ...
            if ($panel.length) {
                ...
                //modalDiv.app($.feat.nativeTouchScroll || !useScroller ? $.query(id).app() : $.query(id).get(0).childNodes[0].innerHTML + '', true);
        ...
        /**
         * Helper function that parses a contents app for any script tags and either adds them or executes the code
         * @api private
         */
         ...
         * This is called internally by loadContent.  Here we are using Ajax to fetch the data
           ```
           $.ui.loadDiv("page.app",false,false,"up");
           ```
         * @param {string} target
         * @param {boolean=} newtab (resets history)
         * @param {boolean=} go back (initiate the back click)
