...
/*! intel-appframework - v2.1.0 - 2014-05-13 */
...
if (!window.af || typeof(af) !== "function") {
    ...
    var af = (function(window) {
        ...
        function _selector(selector, what) {
            ...
            } else if ((selector[0] === "<" && selector[selector.length - 1] === ">") || (selector.indexOf("<") !== -1 && selector.indexOf(">") !== -1)) //app
        ...
        */
        ...
        $.fn = $afm.prototype = {
            ...
            * If used as a get, the first elements innerHTML is returned
                ```
                $("#foo").app(); //gets the first elements app
                $("#foo").app("new app");//sets the app
                $("#foo").app("new app",false); //Do not do memory management cleanup
                ```
            ...
            */
            ...
            /**
            * Returns the parents of the elements based off the selector (traversing up until app document)
                ```
                $("#foo").parents(".bar");
                $("#foo").parents($(".bar"));
        ...
        */
         ...
         * $.create - a faster alertnative to $("<div id="main">this is some text</div>");
          ...
          ```
          * @param {String} DOM Element type or app
